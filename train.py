...
if __name__ == "__main__":
    ...
    classes_path = r'F:\机器学习\relay_baton\yolov4-pytorch-master\model_data\voc_classes.txt'
    ...
    model_path = r"F:\机器学习\relay_baton\yolov4-pytorch-master\model_data\yolo4_weights.pth"
    # 加快模型训练的效率
